...
<div style="margin-top: 40px;">
    ...
    <div style="width: 100%; height: 100vh; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1); border: 1px solid #e1e1e1;">
        <iframe 
            src="https://YOUR-TAILSCALE-URL.ts.net/graphs1090/" 
            width="100%" 
            height="100%" 
            style="border:none;"
